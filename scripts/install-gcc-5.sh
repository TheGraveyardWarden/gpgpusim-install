...
run_wheezy "yes | /usr/bin/dpkg -i $WD/gcc-5.debs/*.deb"
run_wheezy "yes | /usr/bin/dpkg -i $WD/gcc-5.debs/g++-5.debs/*.deb"
...
run_wheezy "yes | /usr/bin/dpkg -i $WD/cpp-dummy.deb $WD/gcc-dummy.deb $WD/g++-dummy.deb"
