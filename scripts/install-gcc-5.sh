...
run_wheezy "/usr/bin/dpkg -i $WD/gcc-5.debs/*.deb"
run_wheezy "/usr/bin/dpkg -i $WD/gcc-5.debs/g++-5.debs/*.deb"
...
/bin/cp ./assets/cpp-dummy.deb ./assets/gcc-dummy.deb $DEBPATH/$WD
run_wheezy "/usr/bin/dpkg -i $WD/cpp-dummy.deb $WD/gcc-dummy.deb"
